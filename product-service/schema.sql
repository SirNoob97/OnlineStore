...
ALTER TABLE main_categories ALTER COLUMN category_id SET DEFAULT NEXTVAL('sequence_category_id');
...
ALTER TABLE products ADD CONSTRAINT fk_category FOREIGN KEY(category_id) REFERENCES main_categories(category_id);

ALTER TABLE sub_categories ADD CONSTRAINT fk_category FOREIGN KEY(category_id) REFERENCES main_categories(category_id);
