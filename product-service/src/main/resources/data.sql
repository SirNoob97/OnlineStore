...
VALUES (1, 9632587, 'Iphone X', 1156.60, 'Apple IOS', 15, '2001-01-01', 2);

INSERT INTO products (product_id, product_number, product_name, product_price, product_description, product_stock, create_at, category_id)
VALUES (2, 1232587, 'Toshiba', 750.00, 'Core i7', 10, '2006-01-01', 1);

INSERT INTO products (product_id, product_number, product_name, product_price, product_description, product_stock, create_at, category_id)
VALUES (3, 9632512, 'Samsung', 300.45, 'Personal Camera', 20, '2010-01-01', 3);
