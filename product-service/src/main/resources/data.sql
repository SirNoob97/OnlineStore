...
INSERT INTO products (product_id, product_bar_code, product_name, product_price, product_description, product_stock, product_status, create_at, category_id)
VALUES (2, 1232584561287, 'Dell Express', 750.00, 'Core i7', 10, 'CREATED', '2006-01-01', 1);

INSERT INTO products (product_id, product_bar_code, product_name, product_price, product_description, product_stock, product_status, create_at, category_id)
VALUES (3, 9632632456512, 'Samsung Camera X5', 300.45, 'Personal Camera', 20, 'CREATED', '2010-01-01', 3);
